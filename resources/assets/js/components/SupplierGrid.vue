                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td>
                                <a v-bind:href="'/supplier/' + row.Id + '-' + row.Slug "> {{ row.Company }}</a>
                            </td>
                            <td>
                                {{ row.Created }}
                            </td>
                            <td><a v-bind:href="'/supplier/' + row.Id + '/edit'">
...
<script>
    export default {
        ...
        data: function () {
            return {
                query: '',
                gridColumns: ['Id', 'Name', 'Company', 'Created'],
                gridData: [],
                total: null,
                next_page_url: null,
                prev_page_url: null,
        ...
        methods: {
            ...
            loadData: function () {
                $.getJSON('api/suppliers-data', function (data) {
                    ...
                    this.first_page_url = 'api/suppliers-data?page=1';
                    this.last_page_url = 'api/suppliers-data?page=' + this.last_page;
                    this.setPageNumbers();
                }.bind(this));
            },
                ...
                if (this.query == '' && getPage != null) {
                    ...
                    if (getPage != null) {
                        $.getJSON(getPage, function (data) {
                            ...
                            this.first_page_url = 'api/suppliers-data?page=1&keyword=' + this.query;
                            this.last_page_url = 'api/suppliers-data?page=' + this.last_page + '&keyword=' + this.query;
                            this.current_page = data.current_page;
