        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <pos-autocomplete src="/api/items" placeholder="Search product" :select="autocompleteSelect"></pos-autocomplete>
                </div>
                ...
                <div class="panel-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <pos-autocomplete src="/api/suppliers" placeholder="Search supplier" :select="selectSupplier"></pos-autocomplete>
                        </div>
